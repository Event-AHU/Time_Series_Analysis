from data_provider.data_loader import UnivariateDatasetBenchmark, MultivariateDatasetBenchmark, Global_Temp, Global_Wind, Dataset_ERA5_Pretrain, Dataset_ERA5_Pretrain_Test, UTSD, UTSD_Npy, PSMSegLoader, MSLSegLoader, SMDSegLoader, SMAPSegLoader
    ...
    if args.task_name == 'anomaly_detection':
        ...
        if flag in ['train', 'val']:
            data_set = Data(
                ...
                flag=flag,
                size=[args.seq_len, args.input_token_len, args.output_token_len if not args.nonautoregressive else args.test_pred_len],
