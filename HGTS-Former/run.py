...
if __name__ == '__main__':
    ...
    # HypergraphTime
    parser.add_argument("--edge_num", type=int, default=4, help="number of hyper edge")
    parser.add_argument("--temperature", type=float, default=0.5, help="softmax temperature")
    parser.add_argument("--sparsity", type=float, default=0.6, help="hyper graph sparsity")
    parser.add_argument("--topp", type=float, default=0.6, help="topp")
    parser.add_argument("--confidence", type=float, default=0.5, help="confidence")

    # imputation
    parser.add_argument("--mask_rate", type=float, default=0.25, help="for imputation")
    parser.add_argument('--features', type=str, default='M',
                        help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate')

    # anomaly_detection
    parser.add_argument("--anomaly_ratio", type=int, default=1, help="for anomaly_detection")
    ...
    if args.dp:
        ...
        dist.init_process_group(backend="nccl", init_method=f"tcp://{ip}:{port}", world_size=2,
                                rank=rank)
